...
function LandingPage() {
    return (
        <>
            ...
            <p>Initially, you are shown a list of previously saved recipe names and a fun word cloud that was made based on the recipe entry's description. To add a new recipe, click on 'Add Recipe' and you will be prompted to provide some details such as the name of the recipe, the link, a description, and any additional notes you want.</p>
