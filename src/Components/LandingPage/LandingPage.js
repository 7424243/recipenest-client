...
function LandingPage() {
    return (
        <div className='landing-page-container'>
            ...
            <p>Initially, you are shown a list of previously saved recipe names.</p> 
            <p>To view a saved recipe, click on the recipe name. </p>
            <p>To add a new recipe, click on 'Add Recipe' and you will be prompted to provide some details such as the name of the recipe, the link, and any additional notes you want.</p>
